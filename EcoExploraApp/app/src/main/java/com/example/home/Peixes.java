    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (animaisList != null) { // Cria botoes
            for (int i = 0; i < animaisList.size(); i++) {
                ...
                if (animal.getAnimalType() == 6) { // Filtra peixes
                    peixes++; // Contador de peixes
                    Log.d("TAG", "onCreate: "+ peixes);
                    // Cria e configura cardView
                    CardView cardView = new CardView(Peixes.this);
                    ...
                    ConstraintLayout targetLayout = (peixes % 2 == 0) ? constraintLayout2 : constraintLayout1; // Define qual constraint o botao sera adicionado
                    ...
                    TextView textView = new TextView(Peixes.this);
                    ...
                    ImageView imageView = new ImageView(Peixes.this);
                    ...
                    Glide.with(Peixes.this) // Adiciona imagem atraves do glide, pegando o URL
