        ...
        if (animaisList != null) { // Cria botoes
            for (int i = 0; i < animaisList.size(); i++) {
                ...
                if (animal.getAnimalType() == 4) { // Filtra mamíferos
                    ...
                    ConstraintLayout targetLayout = (anfibios % 2 == 0) ? constraintLayout2 : constraintLayout1; // Define qual constraint o botao sera adicionado
                    ...
                    TextView textView = new TextView(Anfibios.this);
                    ...
                    ImageView imageView = new ImageView(Anfibios.this);
                    ...
                    Glide.with(Anfibios.this) // Adiciona imagem atraves do glide, pegando o URL
