    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (animaisList != null) { // Cria botoes
            for (int i = 0; i < animaisList.size(); i++) {
                ...
                if (animal.getAnimalType() == 2) { // Filtra Repteis
                    repteis++; // Contador de Repteis
                    Log.d("TAG", "onCreate: "+ repteis);
                    // Cria e configura cardView
                    CardView cardView = new CardView(Repteis.this);
                    ...
                    ConstraintLayout targetLayout = (repteis % 2 == 0) ? constraintLayout2 : constraintLayout1; // Define qual constraint o botao sera adicionado
                    ...
                    TextView textView = new TextView(Repteis.this);
                    ...
                    ImageView imageView = new ImageView(Repteis.this);
                    ...
                    Glide.with(Repteis.this) // Adiciona imagem atraves do glide, pegando o URL
